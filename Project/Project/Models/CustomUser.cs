...
namespace Project.Models
{
    public class CustomUser : IdentityUser
    {
        ...
        {
            return string.Format(" name:{0}; username:{1}; password:{2}; type:{3}; workplace: {4}; phonenumber: {5}; email: {6}; age:{7}; dateofbirth:{8}; education:{9}; language:{10}; toeic: {11}; experience:{12}; department:{13}; location:{14}; Id:{15}",
             this.name, this.UserName, this.PasswordHash, this.type, this.workplace, this.PhoneNumber, this.Email, this.dob, this.edu, this.language, this.toeic, this.exp, this.department, this.location, this.Id);
        }
    }
}